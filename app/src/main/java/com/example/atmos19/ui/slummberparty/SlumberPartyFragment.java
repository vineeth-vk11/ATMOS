package com.example.atmos19.ui.slummberparty;
    ...
    private void setAdapter(int filterBy) {
        ...
        mDayThrreeCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                smoothScroller.setTargetPosition(noDayOne + noDayTwo);
                manager.startSmoothScroll(smoothScroller);
            }
        });
        ...
        mDayFourTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //TODO: Set target scroll position for day 3
                smoothScroller.setTargetPosition(noDayOne + noDayTwo + noDayThree);
                manager.startSmoothScroll(smoothScroller);
            }
        });
